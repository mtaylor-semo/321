...
\renewcommand\allcapsspacing[1]{{\addfontfeatures{LetterSpace=5}#1}}
\renewcommand\smallcapsspacing[1]{{\addfontfeatures{LetterSpace=3}#1}}

\title{{\scshape bi}~321 Genetics Review}
